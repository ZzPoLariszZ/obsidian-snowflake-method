...
<p align="center"><img src="assets/screenshots/snowflake-method-steps-en.gif" width="100%" alt="Animated walkthrough of the ten Snowflake Method steps" /></p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_01_en.png"><img src="assets/screenshots/step_01_en.png" width="100%" alt="Step 1 — One-sentence summary" /></a><br />
      <strong>1. One-sentence summary</strong><br />
      <sub>Define your target readers and distill the whole story into one sentence.</sub>
    </td>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_02_en.png"><img src="assets/screenshots/step_02_en.png" width="100%" alt="Step 2 — One-paragraph summary" /></a><br />
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_03_en.png"><img src="assets/screenshots/step_03_en.png" width="100%" alt="Step 3 — Major character sheet" /></a><br />
      <strong>3. Major character sheet</strong><br />
      <sub>Capture each major character's storyline, motivation, conflict, and growth.</sub>
    </td>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_04_en.png"><img src="assets/screenshots/step_04_en.png" width="100%" alt="Step 4 — Plot synopsis" /></a><br />
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_05_en.png"><img src="assets/screenshots/step_05_en.png" width="100%" alt="Step 5 — Character synopsis" /></a><br />
      <strong>5. Character synopsis</strong><br />
      <sub>Retell the story from each character's point of view.</sub>
    </td>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_06_en.png"><img src="assets/screenshots/step_06_en.png" width="100%" alt="Step 6 — Long synopsis" /></a><br />
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_07_en.png"><img src="assets/screenshots/step_07_en.png" width="100%" alt="Step 7 — Character profiles" /></a><br />
      <strong>7. Character profiles</strong><br />
      <sub>Keep detailed, reusable profiles for every character in the novel.</sub>
    </td>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_08_en.png"><img src="assets/screenshots/step_08_en.png" width="100%" alt="Step 8 — Scene list" /></a><br />
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_09_en.png"><img src="assets/screenshots/step_09_en.png" width="100%" alt="Step 9 — Scene planning" /></a><br />
    ...
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_10_en.png"><img src="assets/screenshots/step_10_en.png" width="100%" alt="Step 10 — Write your novel" /></a><br />
...
<p align="center"><a href="assets/screenshots/workspace_beat_sheet_en.png"><img src="assets/screenshots/workspace_beat_sheet_en.png" width="100%" alt="The Visualization workspace on its Beat sheet tab: a sheet made from the Save the Cat template chosen in the field above, Act 1 and Act 2 each a header with a handle, a + and a menu, the beats of each act down the left with their names and descriptions against an axis with a node at every beat, three scene cards placed under Opening Image and two under Break into Two, Add act and Add beat sheet at the end of the toolbar, and the scene pool on the right empty and reading Every scene is placed" /></a></p>

**Beat sheet** asks a third question: what each scene is for in the shape of the story. A project keeps as many sheets as you like and shows one at a time, and a new one starts blank or from a template: Three Act, Kishōtenketsu, Story Circle, Save the Cat, Hero's Journey and Romancing the Beat are built in, each with its acts, its beats and a line on what every beat is there to do. Acts number themselves by their order and take a label if you give one, and a beat keeps its name and description in the sheet itself, since no note stands behind it. Under a beat you write sub-descriptions and place scenes from the pool exactly as on a timeline, acts, beats, rows and scenes all move by drag or by menu, and the toolbar hides the sub-descriptions, stacks the scenes, turns the sheet to show the last act first, and saves the sheet on show as a template of your own.
...
<p align="center"><img src="assets/screenshots/snowflake-method-steps-cn.gif" width="100%" alt="雪花写作法十个步骤的动态演示" /></p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_01_cn.png"><img src="assets/screenshots/step_01_cn.png" width="100%" alt="第一步——一句话概述" /></a><br />
      <strong>一、一句话概述</strong><br />
      <sub>确定目标读者，用一句话概括完整故事。</sub>
    </td>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_02_cn.png"><img src="assets/screenshots/step_02_cn.png" width="100%" alt="第二步——一段式梗概" /></a><br />
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_03_cn.png"><img src="assets/screenshots/step_03_cn.png" width="100%" alt="第三步——主要角色表" /></a><br />
      <strong>三、主要角色表</strong><br />
      <sub>记录主要角色的故事线、动机、冲突与成长。</sub>
    </td>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_04_cn.png"><img src="assets/screenshots/step_04_cn.png" width="100%" alt="第四步——情节大纲" /></a><br />
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_05_cn.png"><img src="assets/screenshots/step_05_cn.png" width="100%" alt="第五步——人物大纲" /></a><br />
      <strong>五、人物大纲</strong><br />
      <sub>从每位角色的视角重新讲述故事。</sub>
    </td>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_06_cn.png"><img src="assets/screenshots/step_06_cn.png" width="100%" alt="第六步——长篇大纲" /></a><br />
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_07_cn.png"><img src="assets/screenshots/step_07_cn.png" width="100%" alt="第七步——角色档案" /></a><br />
      <strong>七、角色档案</strong><br />
      <sub>为小说中的每个人物维护详细、可复用的完整档案。</sub>
    </td>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_08_cn.png"><img src="assets/screenshots/step_08_cn.png" width="100%" alt="第八步——场景列表" /></a><br />
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_09_cn.png"><img src="assets/screenshots/step_09_cn.png" width="100%" alt="第九步——场景规划" /></a><br />
      <strong>九、场景规划<em>（可选）</em></strong><br />
      <sub>进一步设计冲突、转折、节奏与令人难忘的场景细节。</sub>
    </td>
    <td width="50%" valign="top">
      <a href="assets/screenshots/step_10_cn.png"><img src="assets/screenshots/step_10_cn.png" width="100%" alt="第十步——开始创作吧" /></a><br />
...
<p align="center"><a href="assets/screenshots/workspace_beat_sheet_cn.png"><img src="assets/screenshots/workspace_beat_sheet_cn.png" width="100%" alt="可视化工作区的节拍表标签页：上方的选择框里选着由救猫咪模板建成的节拍表，第 1 幕「建立」与第 2 幕「新世界」各有一行带拖动手柄、加号和菜单的幕标题，左侧依次列出每一幕的节拍及其名称与描述，旁边的轴线在每个节拍处有一个节点，开场画面下放着三张场景卡片，进入第二幕下放着两张，工具栏末尾是添加幕与添加节拍表，右侧的场景池为空，写着所有场景都已放入" /></a></p>

**节拍表**问的是第三个问题：每个场景在故事的形状里起什么作用。一个项目可以保存任意多张节拍表，每次显示一张，新的节拍表可以从空白开始，也可以从模板开始：三幕式、起承转合、故事圈、救猫咪、英雄之旅和言情节拍都是内置的，各自带着幕、节拍，以及每个节拍用来做什么的一句说明。幕按次序自动编号，你愿意的话可以再给它一个标签，节拍的名称与描述就保存在节拍表里，因为它背后没有笔记。节拍之下同样写子描述，并从场景池里放入场景，与时间线上完全一样，幕、节拍、子描述和场景都可以拖动，也都可以用菜单移动，工具栏则可以隐藏子描述、堆叠场景、让最后一幕排在前面，并把当前的节拍表保存为你自己的模板。
