...
import { Keymap, Menu, Notice, getIcon, setIcon, setTooltip, type App, type Modal } from 'obsidian';
...
import { MoveAfterModal, promptForEntityReference, type EntityReferenceSource, type MoveAfterEntry, type Translate } from './modals';
