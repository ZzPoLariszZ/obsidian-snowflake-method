...
export const zhCN: Readonly<Record<TranslationKey, string>> = {
	...
	'settings.createFromField.name': '在字段中创建笔记',
	'settings.createFromField.desc': '在字段中填写项目尚未拥有的笔记时的处理方式。',
	'settings.createFromField.form': '打开该笔记的表单',
	...
	'worldbuilding.kind.time.description': '故事用来计量时间的时间点与时间段。',
	...
	'modal.definition.edit.path': '正在编辑「{path}」。重命名后各笔记仍指向这里。',
	'form.description': '描述',
	'form.timeKind': '类型',
