...
export const zhCN: Readonly<Record<TranslationKey, string>> = {
	...
	'commands.cycleManuscriptFocus': '切换专注深度',
	'commands.manuscriptFocus.off': '专注已关闭。',
	'commands.manuscriptFocus.on': '专注已开启。',
	'commands.manuscriptFocus.deep': '专注已加深：工作台也随之淡化。',
	'commands.manuscriptFocus.solo': '现在只显示正文。',
	...
	'settings.manuscriptWindow.name': '同时载入的笔记数',
	'settings.manuscriptWindow.desc':
		'在正在阅读的笔记之前保留多少篇、之后保留多少篇。数值越大，滚动时越少因载入而停顿，占用的内存也越多。',
	'settings.manuscriptPath.name': '显示每篇笔记的文件路径',
	'settings.manuscriptPath.desc': '在笔记上方显示它在 Vault 中的存放位置。',
	'settings.manuscriptSequence.name': '显示每篇笔记的顺序编号',
	'settings.manuscriptSequence.desc':
		'显示决定每篇笔记阅读位置的“snowflake-manuscript-sequence”属性；核对顺序时有用，写作时无需开启。',
	'settings.manuscriptTypewriter.name': '打字机滚动',
	'settings.manuscriptTypewriter.desc':
		'让正在写的那一行停在页面中部，移动的是页面。鼠标点击仍会把所点的词留在指针下；从第一次按键起，页面开始随行居中。',
	'settings.manuscriptFocus.name': '专注模式',
	'settings.manuscriptFocus.levelOff': '关',
	'settings.manuscriptFocus.levelOn': '开',
	'settings.manuscriptFocus.levelDeep': '深',
	'settings.manuscriptFocus.levelSolo': '仅正文',
	'settings.manuscriptFocus.off': '一切保持原样。',
	'settings.manuscriptFocus.on':
		'写作时，除正在写的段落外全部淡化——本篇的其余部分、相邻的笔记，以及应用的其余界面。工作台保持明亮，被淡化的部分悬停即可看清。',
	'settings.manuscriptFocus.deep': '在「开」的基础上，工作台也随其余一切一同淡化。',
	'settings.manuscriptFocus.solo':
		'仅正文：进入全屏，隐藏应用的其余一切，笔记的路径与顺序编号也一并隐去；转到别处即全部恢复。',
	...
	'manuscript.focusLevel.off': '专注：关',
	'manuscript.focusLevel.on': '专注：开',
	'manuscript.focusLevel.deep': '专注：深',
	'manuscript.focusLevel.solo': '专注：仅正文',
	'manuscript.focusNext.on': '点击切换为：开',
	'manuscript.focusNext.deep': '点击切换为：深',
