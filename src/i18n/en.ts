export const en = {
	...
	'editor.managedSection.name.details': 'Details',
	...
	'worldbuilding.kind.location': 'Locations',
	'worldbuilding.kind.item': 'Items',
	'worldbuilding.kind.time.description':
		'The points, periods, and events your story counts time by.',
	'worldbuilding.kind.location.description':
		'The places your scenes happen and your entities live at.',
	'worldbuilding.kind.item.description':
		'The objects your story keeps track of.',
	'worldbuilding.add.time': 'Add time note',
	'worldbuilding.add.location': 'Add location',
	'worldbuilding.add.item': 'Add item',
	'worldbuilding.empty.time': 'No time notes yet.',
	'worldbuilding.empty.location': 'No locations yet.',
	'worldbuilding.empty.item': 'No items yet.',
	'worldbuilding.search.time': 'Search time notes',
	'worldbuilding.search.location': 'Search locations',
	'worldbuilding.search.item': 'Search items',
	'worldbuilding.delete': 'Delete',
	'modal.entity.title.time': 'New time note',
	'modal.entity.title.location': 'New location',
	'modal.entity.title.item': 'New item',
	'modal.entity.editTitle.time': 'Edit time note',
	...
	'form.category.placeholder': 'Pick or create a category path',
	'form.category.create': 'Create category "{name}"',
	'form.category.remove': 'Remove {name}',
	'form.description': 'Description',
	'form.timeKind': 'Type',
	'form.timeKind.point': 'Point in time',
	'form.timeKind.period': 'Period',
	'form.timeKind.event': 'Event',
	...
	'form.record.add': 'Add record',
	'form.record.label': 'Label',
	'form.record.createLabel': 'Create label "{name}"',
	...
	'form.period.halfSpan':
		'A period needs both its start and its end, or neither.',
