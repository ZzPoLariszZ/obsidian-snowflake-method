export const en = {
	...
	'commands.addWorldbuildingNote': 'Add worldbuilding note',
	'commands.createWorldbuildingKind': 'Create worldbuilding kind',
	'commands.openWorldbuildingBase': 'Open worldbuilding base',
	'commands.add.category': 'Add category',
	'commands.add.world-status': 'Add world status',
	'commands.add.relationship': 'Add relationship',
	...
	'statusBar.unitWords': 'words',
	'statusBar.unitCharacter': 'character',
	'statusBar.unitCharacters': 'characters',
	'statusBar.statWords': 'Words: {count}',
	'statusBar.statCharactersNoSpaces': 'Characters (no spaces): {count}',
	'statusBar.statCharactersWithSpaces': 'Characters (with spaces): {count}',
	'statusBar.statNonAsianWords': 'Non-Asian words: {count}',
	'statusBar.statAsianCharacters': 'Asian characters: {count}',
	'statusBar.statNotes': 'Notes: {count}',
	'statusBar.statUnreadable': 'Could not be read: {count}',
	'statusBar.scopeProject': 'Project',
	'statusBar.scopeManuscript': 'Manuscript',
	...
	'projectStructure.issue.unregistered-worldbuilding-kind':
		'These notes carry a worldbuilding kind this project does not list:',
	'projectStructure.action.unregistered-worldbuilding-kind':
		'Repairing here registers the kind and its folder.\nA registry edit or a restored backup can leave notes this way.',
	...
	'worldbuilding.kind.add': 'Add more kinds…',
	'worldbuilding.kind.options': 'Options for the {name} kind',
	'worldbuilding.add.time': 'Add time',
	'worldbuilding.add.location': 'Add location',
	'worldbuilding.add.item': 'Add item',
	'worldbuilding.add.custom': 'Add {name}',
	...
	'worldbuilding.search.custom': 'Search {name}',
	...
	'worldbuilding.insertAfter.custom': 'Insert {name} after',
	'modal.entity.title.time': 'Add time',
	'modal.entity.title.location': 'Add location',
	'modal.entity.title.item': 'Add item',
	'modal.entity.title.custom': 'Add {name}',
	'modal.entity.editTitle.time': 'Edit time',
	'modal.entity.editTitle.location': 'Edit location',
	'modal.entity.editTitle.item': 'Edit item',
	'modal.entity.editTitle.custom': 'Edit {name}',
	'modal.kind.createTitle': 'Add kind',
	'modal.kind.editTitle': 'Edit {name}',
	'modal.kind.name': 'Name',
	'modal.kind.icon': 'Icon',
	'modal.kind.iconDescription': 'Select any Lucide icon by its name.',
	'modal.kind.iconPlaceholder': 'Search icons…',
	'modal.kind.description': 'Description',
	'modal.kind.nameTaken': 'Another kind already answers to "{name}".',
	'modal.kind.full':
		'No room for another kind: every prefix up to 6Z is taken.',
	'modal.kind.invalidName': '"{name}" cannot name a kind.',
	'modal.deleteKind.title': 'Delete {name}?',
	'modal.deleteKind.description':
		'Every note of this kind goes to the trash with its folder and vocabularies: {count} note(s) in all.',
	'modal.deleteKind.listed': 'These notes list a {name} entry and lose it:',
	...
	'messages.kindCreated': 'Created the kind {name}.',
	'messages.kindRenamed': 'Renamed the kind to {name}.',
	'messages.kindDeleted': 'Moved the kind {name} to the trash.',
