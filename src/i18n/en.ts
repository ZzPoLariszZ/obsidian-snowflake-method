export const en = {
	...
	'commands.openMentions': 'Open entity mentions',
	...
	'settings.mentionHighlight.name': 'Highlight entity mentions',
	'settings.mentionHighlight.desc':
		'Mark names and aliases of this project’s members where they stand in the manuscript. Unlinked mentions are the ones not yet written as links.',
	...
	'settings.customMatching.heading': 'Custom text matching',
	'settings.customMatching.enable': 'Enable custom highlights',
	'settings.customMatching.enableDesc':
		'The master switch over every rule below. Matches only decorate the manuscript stream and are never counted or stored.',
	'settings.customMatching.rules': 'Highlight rules',
	'settings.customMatching.add': 'Add rule',
	'settings.customMatching.empty':
		'No rules yet. Add one to highlight your own words or patterns in the manuscript stream.',
	'settings.customMatching.kindLiteral': 'Literal text',
	'settings.customMatching.kindRegex': 'Regular expression',
	'settings.customMatching.ruleDesc': '{kind} · {count} patterns',
	'settings.customMatching.ruleDescOne': '{kind} · 1 pattern',
	'settings.customMatching.off': 'Off',
	'settings.customMatching.broken':
		'A pattern does not compile and is skipped',
	'settings.sensitiveWords.heading': 'Sensitive words',
	'settings.sensitiveWords.enable': 'Track sensitive words',
	'settings.sensitiveWords.enableDesc':
		'Match the list below across the manuscript, warn in the stream, and count every spot in the tracking pane.',
	'settings.sensitiveWords.list': 'Word list',
	'settings.sensitiveWords.listDesc':
		'One term per line. Latin terms also match their case variants.',
	'settings.dialogue.heading': 'Dialogue',
	'settings.dialogue.enable': 'Detect dialogue',
	'settings.dialogue.enableDesc':
		'Read quoted stretches for the dialogue statistics and the tracking pane.',
	...
	'settings.dialoguePresentation.off': 'Plain',
	...
	'settings.proseStatistics.heading': 'Prose statistics',
	'settings.readingWordsPerMinute.name': 'Reading speed, words per minute',
	'settings.readingWordsPerMinute.desc':
		'How fast space-delimited words are read, for the estimated reading time.',
	'settings.readingCjkCharactersPerMinute.name':
		'Reading speed, CJK characters per minute',
	'settings.readingCjkCharactersPerMinute.desc':
		'How fast CJK characters are read, for the estimated reading time.',
	'settings.customStopwords.name': 'Custom stopwords',
	'settings.customStopwords.desc':
		'Words the frequency table passes over, beside the built-in lists. Separate with spaces, commas or new lines.',
	'modal.highlightRule.createTitle': 'New highlight rule',
	...
	'modal.highlightRule.patternsDesc': 'One per line.',
	'modal.highlightRule.patternsPlaceholder': 'One pattern per line',
	...
	'modal.highlightRule.color': 'Color',
	'modal.highlightRule.followAccent':
		'Turn the switch on to follow the theme accent, off to pick a color.',
	'modal.highlightRule.enabled': 'Enabled',
	...
	'settings.manuscriptAppearance.heading': 'Manuscript typography',
	...
	'manuscript.toolbar.trackMentions': 'Track mentions',
	'mentionView.title': 'Entity mentions',
	...
	'mentionView.last': 'Last: {name}',
	'mentionView.unresolvedHeading': 'Unresolved mentions',
	'mentionView.unresolvedHint': 'Could be: {names}',
	'mentionView.sensitiveHeading': 'Sensitive words',
	'mentionView.sensitiveCount': '{total} found',
	'mentionView.dialogueHeading': 'Dialogue',
	'mentionView.dialogueCount': '{count} quoted',
