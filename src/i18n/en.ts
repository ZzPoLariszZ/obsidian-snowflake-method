export const en = {
	...
	'commands.cycleManuscriptFocus': 'Cycle focus',
	'commands.manuscriptFocus.off': 'Focus is off.',
	'commands.manuscriptFocus.on': 'Focus is on.',
	'commands.manuscriptFocus.deep': 'Focus is deep: the dashboard fades too.',
	'commands.manuscriptFocus.solo': 'Focus is solo: nothing but the manuscript.',
	...
	'settings.manuscriptTypewriter.desc':
		'Hold the line being written at the middle of the page, and move the page instead. A mouse click still leaves the clicked words under the pointer; the page recentres from the first keystroke.',
	...
	'settings.manuscriptFocus.off': 'Everything stays bright.',
	'settings.manuscriptFocus.on':
		'While writing, all but the paragraph being written fades — the rest of the note, the neighbouring notes, and the rest of the app. The dashboard stays bright, and anything faded returns on hover.',
	'settings.manuscriptFocus.deep':
		'As on, and the dashboard fades with everything else.',
	'settings.manuscriptFocus.solo':
		'Nothing but the manuscript, full screen: the rest of the app is hidden, and each note’s path and order number with it. It all returns the moment you go anywhere else.',
	...
	'dashboard.emptyCharacters': 'No characters yet.',
	'dashboard.emptyScenes': 'No scenes yet.',
	'dashboard.openArtifact': 'Open step note',
	'dashboard.addCharacter': 'Add character',
	'dashboard.addScene': 'Add scene',
	...
	'table.name': 'Name',
	'table.characterType': 'Type',
	'table.characterTypeShort': 'Type',
	...
	'character.majorShort': 'Major',
	'character.supportingShort': 'Supporting',
	'character.minorShort': 'Minor',
	'modal.scene.title': 'Add scene',
	'modal.scene.editTitle': 'Edit scene',
	'modal.scene.name': 'Scene name',
	...
	'manuscript.focusLevel.off': 'Focus: off',
	'manuscript.focusLevel.on': 'Focus: on',
	'manuscript.focusLevel.deep': 'Focus: deep',
	'manuscript.focusLevel.solo': 'Focus: solo',
