export const en = {
	...
	'session.scope.manuscript': 'Manuscript only',
	...
	'sessionMenu.start.stopwatch': 'Start stopwatch session',
	'sessionMenu.start.countdown': 'Start countdown session',
	'sessionMenu.start.pomodoro': 'Start pomodoro session',
	'sessionMenu.startWithOptions': 'Start with options…',
	'sessionMenu.pause': 'Pause session',
	'sessionMenu.resume': 'Resume session',
	'sessionMenu.stop': 'Stop session',
	'sessionMenu.openStatistics': 'Open statistics',
	...
	'session.modal.title': 'Start a writing session',
	'session.modal.type': 'Session type',
	'session.modal.scope': 'Counting scope',
	'session.modal.scopeDesc':
		'What counts as writing: any note of the project, or only the manuscript.',
	'session.modal.mode': 'Writing mode',
	'session.modal.goalNet': 'Goal: net words',
	'session.modal.goalDesc':
		'Leave a goal blank to set no condition. With both set, both must be met.',
	'session.modal.goalFocus': 'Goal: focus minutes',
	'session.modal.start': 'Start',
	'sessionPanel.today': 'Today',
	'sessionPanel.todayEmpty': 'No sessions yet today.',
