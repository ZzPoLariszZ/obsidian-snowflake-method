export const en = {
	...
	'settings.createFromField.name': 'Making a note from a field',
	'settings.createFromField.desc':
		'What happens when a field is asked for a note the project does not have yet.',
	'settings.createFromField.form': 'Open its form',
	'settings.createFromField.now': 'Create it straight away',
	...
	'worldbuilding.kind.time.description':
		'The points and periods your story counts time by.',
